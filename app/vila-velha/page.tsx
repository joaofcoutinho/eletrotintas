...
import { MapPin, Phone, Mail, Clock, Star, ExternalLink, ArrowRight, Building, ChevronRight, FileText } from "lucide-react"
...
const testimonials = [
  ...
  },
  {
    ...
    name: "Paulo Pinto",
    role: "Cliente",
    content: "Muita variedade e bom atendimento, bom suporte técnico, uma das melhores do estado.",
    rating: 5,
  },
  {
    id: 3,
    name: "Luiz Henrique Barroso",
    role: "Cliente",
    content: "Excelente localização. Estacionamento para clientes. Variedades de produtos.",
    rating: 5,
  },
  {
    id: 4,
    name: "Valentim Carlos dos Santos",
    role: "Cliente",
    content: "Além de terem o menor preço, a qualidade e o atendimento, a atenção prestada são excelentes.",
    rating: 5,
  },
  {
    id: 5,
    name: "Cubus Condominios",
    role: "Cliente",
    content:
      "Excelente empresa. A entrega de materiais é muito rápida. O vendedor Alex nos atende ha alguns meses e tem um ótimo atendimento, muito obrigada!",
    rating: 5,
  },
]
...
export default function VilaVelhaPage() {
  return (
    <main className="flex min-h-screen flex-col">
      {/* WhatsApp Button */}
      <WhatsAppButton phoneNumber="27 99581-1090" store="vila-velha" />
      ...
      <header className="fixed top-0 w-full z-50 bg-white shadow-md">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <ScrollLink to="#produtos">Produtos</ScrollLink>
            <ScrollLink to="#marcas">Marcas</ScrollLink>
            <ScrollLink to="#depoimentos">Depoimentos</ScrollLink>
            <ScrollLink to="#localizacao">Localização</ScrollLink>
          </nav>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in text-white pr-4 md:pr-12">
              <div className="inline-block px-4 py-1 bg-yellow-500/20 backdrop-blur-sm rounded-full text-yellow-300 font-semibold mb-4 border border-yellow-500/30">
                Bem-vindo à Eletrotintas Vila Velha
              </div>
              ...
              <p className="text-xl md:text-2xl font-light text-gray-200">
                Na ELETROTINTAS de Vila Velha, você encontra a linha completa de materiais elétricos e as melhores
                tintas para projetos residenciais, comerciais e industriais.
              </p>
              ...
              <div className="pt-8 grid grid-cols-2 gap-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-white">(27) 3320-9000</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative h-[500px] hidden md:block animate-fade-in animate-delay-200">
              ...
              <WhatsAppLink
                href="https://wa.me/5527995811090"
                store="vila-velha"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
              ELETROTINTAS é referência em materiais eltricos e tintas, com os itens mais escolhidos por profissionais
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-card overflow-hidden card-hover animate-fade-in animate-delay-100">
              <div className="p-6">
                <Image
                  src="/images/conduletes-pvc-andaluz.jpeg"
                  alt="Conduletes PVC Andaluz"
                  width={300}
                  height={300}
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-xl font-bold text-gray-800">Conduletes PVC Andaluz</h3>
                  <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded-full">
                    Elétrica
                  </span>
                </div>
                <p className="text-gray-600 mb-4">
                  Linha completa de conduletes PVC disponível em 4 cores para instalações elétricas.
                </p>
                <div className="flex items-center">
                  <div className="flex">
            ...
            <div className="bg-white rounded-xl shadow-card overflow-hidden card-hover animate-fade-in animate-delay-200">
              <div className="p-6">
                <Image
                  src="/images/disjuntores-chint.jpeg"
                  alt="Disjuntores Chint"
                  width={300}
                  height={300}
                  className="w-full h-64 object-cover"
                />
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-xl font-bold text-gray-800">Disjuntores Chint</h3>
                  <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded-full">
                    Elétrica
                  </span>
                </div>
                <p className="text-gray-600 mb-4">
                  Proteção elétrica eficiente e segura para ambientes comerciais e residenciais.
                </p>
                <div className="flex items-center">
                  <div className="flex">
                    <Star className="h-4 w-4 text-yellow-500 fill-yellow-500" />
            ...
            <div className="bg-white rounded-xl shadow-card overflow-hidden card-hover animate-fade-in animate-delay-300">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-xl font-bold text-gray-800">Fios Corfio</h3>
                  <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded-full">
                    Elétrica
                  </span>
                </div>
                <p className="text-gray-600 mb-4">
                  Fios e cabos elétricos de alta qualidade em diversas cores e bitolas para instalações seguras.
                </p>
                <div className="flex items-center">
                  <div className="flex">
                    <Star className="h-4 w-4 text-yellow-500 fill-yellow-500" />
            ...
            {/* Product Card 4 - Coral Rende Muito */}
            <div className="bg-white rounded-xl shadow-card overflow-hidden card-hover animate-fade-in animate-delay-100">
              <div className="p-6">
                <Image
                  src="/images/coral-rende-muito-transparente.png"
                  alt="Coral Rende Muito"
                  width={300}
                  height={300}
                  className="w-full h-64 object-contain"
                />
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-xl font-bold text-gray-800">Coral Rende Muito</h3>
                  <span className="bg-red-100 text-red-800 text-xs font-semibold px-2.5 py-0.5 rounded-full">
                    Tintas
                  </span>
                </div>
                <p className="text-gray-600 mb-4">
                  Tinta concentrada com ótima cobertura e baixo odor para ambientes internos e externos.
                </p>
                <div className="flex items-center">
                  <div className="flex">
                    <Star className="h-4 w-4 text-yellow-500 fill-yellow-500" />
            ...
            {/* Product Card 5 - Sherwin Williams Metalatex */}
            <div className="bg-white rounded-xl shadow-card overflow-hidden card-hover animate-fade-in animate-delay-200">
              <div className="p-6">
                <Image
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-xl font-bold text-gray-800">Sherwin Williams Metalatex</h3>
                  <span className="bg-red-100 text-red-800 text-xs font-semibold px-2.5 py-0.5 rounded-full">
                    Tintas
                  </span>
                </div>
                <p className="text-gray-600 mb-4">
                  Tinta acrílica premium super lavável com acabamento fosco para ambientes internos e externos.
                </p>
                <div className="flex items-center">
                  <div className="flex">
                    <Star className="h-4 w-4 text-yellow-500 fill-yellow-500" />
            ...
            {/* Product Card 6 - Renner Emborrachada */}
            <div className="bg-white rounded-xl shadow-card overflow-hidden card-hover animate-fade-in animate-delay-300">
              <div className="p-6">
                <Image
                  src="/images/renner-emborrachada-transparente.png"
                  alt="Renner Frentes & Fachadas Emborrachada"
                  width={300}
                  height={300}
                  className="w-full h-64 object-contain"
                />
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-xl font-bold text-gray-800">Renner Frentes & Fachadas</h3>
                  <span className="bg-red-100 text-red-800 text-xs font-semibold px-2.5 py-0.5 rounded-full">
                    Tintas
                  </span>
                </div>
                <p className="text-gray-600 mb-4">
                  Tinta acrílica emborrachada premium com impermeabilizante para fachadas e áreas externas.
                </p>
                <div className="flex items-center">
                  <div className="flex">
                    <Star className="h-4 w-4 text-yellow-500 fill-yellow-500" />
      ...
      <section id="localizacao" className="py-20 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <div className="w-24 h-1 bg-red-500 mx-auto mb-6"></div>
            <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
              Visite nossa loja em Cariacica e conheça nosso showroom completo de materiais elétricos e tintas.
            </p>
          </div>
              ...
              <div className="overflow-hidden rounded-2xl shadow-2xl animate-fade-in animate-delay-200 group">
                <div className="relative h-[300px] overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 p-6 text-white">
                    <h3 className="text-2xl font-bold mb-2">Eletrotintas Vila Velha</h3>
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start transform transition-all duration-300 hover:translate-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-lg">(27) 3320-9000</p>
                  ...
                  <div className="flex items-start transform transition-all duration-300 hover:translate-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-lg">contato@eletrotintas.com.br</p>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-800 to-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <ScrollLink
              to="#localizacao"
              className="bg-white text-blue-700 hover:bg-gray-100 font-bold py-3 px-8 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 inline-flex items-center"
            >
              Como Chegar
            </ScrollLink>
            <Link
