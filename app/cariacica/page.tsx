...
import { MapPin, Phone, Mail, Clock, ChevronRight, Star, ExternalLink, ArrowRight, Building, FileText } from "lucide-react"
...
export default function CariacicaPage() {
  return (
    <main className="flex min-h-screen flex-col">
      {/* WhatsApp Button */}
      <WhatsAppButton phoneNumber="27 99298-1712" store="cariacica" />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in text-white pr-4 md:pr-12">
              <div className="inline-block px-4 py-1 bg-yellow-500/20 backdrop-blur-sm rounded-full text-yellow-300 font-semibold mb-4 border border-yellow-500/30">
                Bem-vindo à Eletrotintas Cariacica
              </div>
              ...
              <p className="text-xl md:text-2xl font-light text-gray-200">
                Na ELETROTINTAS de Cariacica, você encontra a linha completa de materiais elétricos e as melhores tintas
              ...
              <div className="pt-6 flex flex-wrap gap-6">
                <ScrollLink
                  to="#produtos"
                  className="group relative overflow-hidden rounded-lg bg-gradient-to-r from-red-600 to-red-500 px-8 py-4 font-bold text-white shadow-lg transition-all duration-300 hover:shadow-red-500/30 hover:shadow-xl inline-flex items-center"
                >
                ...
                <ScrollLink
                  to="#localizacao"
                  className="group relative overflow-hidden rounded-lg bg-transparent px-8 py-4 font-bold text-white shadow-lg transition-all duration-300 hover:shadow-white/20 hover:shadow-xl border border-white/30 backdrop-blur-sm inline-flex items-center"
                >
                  <span className="relative z-10 flex items-center gap-2">
                    Como Chegar
              ...
              <div className="pt-8 grid grid-cols-2 gap-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-white">(27) 3045-9555</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative h-[500px] hidden md:block animate-fade-in animate-delay-200">
              ...
              <WhatsAppLink
                href="https://wa.me/5527992981712"
                store="cariacica"
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-stretch">
            ...
            <div className="lg:w-1/2 flex flex-col">
              ...
              <div className="mt-6 flex justify-center">
                <a
                  href="https://maps.app.goo.gl/Ld5Eo9Eo9Eo9Eo9E6"
                  target="_blank"
            ...
            <div className="lg:w-1/2 flex flex-col space-y-8">
              ...
              <div className="overflow-hidden rounded-2xl shadow-2xl animate-fade-in animate-delay-200 group">
                <div className="relative h-[300px] overflow-hidden">
                  <Image
                    src="/images/fachada-eletrotintas-cariacica.png"
                    alt="Fachada ELETROMIL Cariacica"
                    fill
                    className="object-cover w-full h-full transform transition-transform duration-700 group-hover:scale-110"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                  <div className="absolute bottom-0 left-0 p-6 text-white">
                    <h3 className="text-2xl font-bold mb-2">Eletrotintas Cariacica</h3>
                ...
                <div className="space-y-8">
                  <div className="flex items-start transform transition-all duration-300 hover:translate-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-lg">Av. Mário Gurgel, 4640 - Vila Capixaba, Cariacica - ES</p>
                      <p className="text-gray-500 text-sm mt-1">CEP: 29148-022</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start transform transition-all duration-300 hover:translate-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-lg">(27) 3045-9555</p>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <ScrollLink to="#localizacao" className="text-gray-300 hover:text-white transition-colors">
                    Av. Mário Gurgel, 4640 - Vila Capixaba, Cariacica - ES
                  </ScrollLink>
                </li>
